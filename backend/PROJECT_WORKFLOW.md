...
## 📋 Executive Summary
A machine learning pipeline that predicts payment delays for invoices submitted by MSMEs to Central PSUs by analyzing **grievance data** + **corporate financial signals** using an **Optuna-XGBoost Bayesian-optimized classifier**.
...
└── Target Variable: High_Risk_Flag
    ├── 1 = RISK (Delay_Risk_Ratio > 46%)
    └── 0 = SAFE (Delay_Risk_Ratio ≤ 46%)
```
...
│
├── Evaluation Metric: Recall (Priority)
...
│
└── Feature Importance: Structural factors dominate
    ├── Public Listing Status (Primary)
    ├── Sector Classification (Primary)
    ├── Profit Margin (0.0% Importance)
    ├── Debt to Equity (0.0% Importance)
    └── ... (others)
```
...
│  │                                                      │  │
│  │  📊 KEY FACTORS:                                    │  │
│  │  ├─ Public Status: Unlisted (High Impact ⬇️)        │  │
│  │  ├─ Sector: Energy_Mining (High Impact ⬇️)          │  │
│  │  ├─ Pending Cases: 72% of total (Negative ⬇️)       │  │
│  │  ├─ Debt/Equity: 1.85x (Negligible Impact ⚪)       │  │
│  │  └─ Profit Margin: 8.5% (Negligible Impact ⚪)       │  │
│  │                                                      │  │
│  │  💡 RECOMMENDATIONS:                                │  │
...
│  │                                                    │  │
│  │ Interpretation:                                    │  │
│  │ • Model correctly predicted 78/128 cases (61.29%)  │  │
│  │ • Successfully caught 88% of high-risk payers      │  │
│  │ • Accuracy reflects data noise & structural complexity│  │
│  └─────────────────────────────────────────────────────┘  │
│                                                             │
...
│  ├──────────────────────────────────────────────────────┤  │
│  │ 1. Public Listing Status   │ █████████░ │ 48.3%  │  │
│  │ 2. Sector Classification   │ ████████░░ │ 51.7%  │  │
│  │ 3. Profit Margin           │ ░░░░░░░░░░ │  0.0%  │  │
│  │ 4. Debt_to_Equity          │ ░░░░░░░░░░ │  0.0%  │  │
...
IF (Profit_Margin < 5%):
   → Note: "Financial health shows negligible predictive power"
